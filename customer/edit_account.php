...
?>
	...
	<form action="" method="post" enctype="multipart/form-data"/>			
     ...
     <table align="center" width="750">
		...
		<tr>
			...
			<td><input type="file" name="c_image"  /><img src="customer_images/<?php echo $image; ?>"width="150px"  height="150px"/></td>
		</tr>
		<tr>
		    <td align="right">Costumer country:</td>
			<td>
	...
	if($run_update){
		...
		echo "<script>alert('Your account update is successfully')</script>";
